...
namespace DotNetKoans.CSharp
{
    public class AboutControlStatements : Koan
    {
        ...
        //sylvia has question on 7 //This is out of place for control statements, but necessary for Koan 8
        [Koan(7)]
